...
class HealthFragment : Fragment(),NewsItemClicked {
    ...
    override fun onCreateView(
        ...
        v = inflater.inflate(R.layout.fragment_health, null)
    ...
    private fun fetchData() {
        ...
        val url =
            "https://gnews.io/api/v4/top-headlines?&token=bd813f1bf3d55923cb997dd8bb6fc752&category=health&lang=hi&breaking-news&country-in"
